...
<div className="tw-flex tw-items-center tw-place-content-center tw-mb-5">
    <a href="https://www.dontusethiscode.com/" className="tablet:tw-w-1/3 tw-w-1/2 tw-bg-[#00323e]" target="_blank">
...
<div className="tw-flex tw-items-center tw-place-content-center tw-space-x-5 tw-mb-5">
    <a href="https://www.phys.ntu.edu.tw/Default.html" className="tablet:tw-w-1/3 tw-w-1/2" target="_blank">
